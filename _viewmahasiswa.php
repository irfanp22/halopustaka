                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="#" data-toggle="modal" data-target="#detailModal" data-id="<?php echo $data['nim'] ?>" class="btn btn-success btndetailmahasiswa" data-id="<?php echo $data["nim"] ?>"><i class="fas fa-circle-info"></i></a>
                                <a href="?page=editmahasiswa&id=<?php echo $data['nim'] ?>" class="btn btn-warning" id="btnedit"><i class="fas fa-pen-to-square"></i></a>
                                <a href="?page=viewmahasiswa&id=<?php echo $data['nim'] ?>" class="btn btn-danger confirmAlert" id="btnhapus"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php
                    }
