        ...
        <div class="modal-content">
            ...
            <form action="dashboard.php?page=viewrak" method="post" name="tkategori">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" name="namakategori" class="form-control" placeholder="Masukan Nama Kategori" required>
                        </div>
                    </div>
                    <hr>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" name="tambahkategori" id="tambahkategori" class="btn btn-primary">Tambah</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                            ...
                            <input type="text" name="namakategori" class="form-control namakategori" placeholder="Masukan Nama Kategori" required>
                        </div>
                    </div>
                    <hr>
                </div>
            ...
            <form action="dashboard.php?page=viewrak" method="post" name="tambahrak">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" name="namarak" class="form-control" placeholder="Masukan Nama Rak" required>
                        </div>
                    </div>
                    <hr>
                </div>
...
<div class="modal fade" id="editRak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="dashboard.php?page=viewrak" method="post" name="erak">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" name="idrak" class="form-control idrak" placeholder="Masukan ID Rak" required>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" name="namarak" class="form-control namarak" placeholder="Masukan Nama Rak" required>
                        </div>
                    </div>
                    <hr>
                </div>
