    ...
    <div class="row">
        <div class="card border-left-primary shadow col-md-4">
            <div class="card-body text-center">
                <img src="assets/img/<?php echo $data['pic'] ?>" alt="<?php echo $data['nama'] ?>" width="150px" id="ppic">
                <h6><?php echo $data['nama'] ?></h6>
                <a href="#" data-toggle="modal" data-target="#passModal" class="btn btn-primary">Ganti Password</a>
            </div>
        </div>
